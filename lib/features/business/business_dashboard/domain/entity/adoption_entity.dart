...
class BusinessAdoptionEntity extends Equatable {
  final String? id;
  final String petId;
  final String userId;
  ...
  BusinessAdoptionEntity copyWith({
    String? id,
    String? petId,
    String? userId,
    String? businessId,
    String? status,
    ApplicationDetailsEntity? applicationDetails,
...
class ApplicationDetailsEntity extends Equatable {
  ...
  const ApplicationDetailsEntity({
