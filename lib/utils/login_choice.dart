...
import 'package:pet_connect/utils/signup_choice.dart';
...
class _LoginChoiceScreenState extends State<LoginChoiceScreen>
  ...
  final Widget _userSignupScreen = const SignupChoiceScreen();
        ...
        children: [
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => _userSignupScreen),
              );
            },
            child: Text(
              'Signup!',
